...
public class DroidPlannerApp extends MultiDexApplication implements DroneListener, TowerListener, LinkListener {
    ...
    // 断开连接的延迟，1000ms
    private static final long DELAY_TO_DISCONNECTION = 1000L;

    // 标签，使用类加载器获取，此处TAG == "DroidPlannerApp"
    private static final String TAG = DroidPlannerApp.class.getSimpleName();

    // 切换无人机连接，此处值为 "org.droidplanner.android.ACTION_TOGGLE_DRONE_CONNECTION"
    ...
    // handler对象,主要接受子线程发送的数据， 并用此数据配合主线程更新UI
    private final Handler handler = new Handler();

    // 处理线程的其他异常，Error和RuntimeException及其子类
