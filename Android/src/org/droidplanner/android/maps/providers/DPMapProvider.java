...
public enum DPMapProvider {
	...
	BAIDU_MAP {
		...
		@Override
		public BaiduMapPrefFragment getMapProviderPreferences() {
			return new BaiduMapPrefFragment();
		}
	};
	 ...
	 */
	public abstract BaiduMapPrefFragment getMapProviderPreferences();
	...
	/**
	 * By default, Baidu Map is the map provider.
	 */
